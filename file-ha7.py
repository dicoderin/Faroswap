...
╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝
    """)
    print("Pharos Username Minter v7.5 | Professional Enhanced Commit-Register Process")
    print("=" * 60)
...
class PharosMultiMinter:
    def __init__(self, private_key, user_agent=None, max_retries=5):
        ...
        # Initialize cached values with hardcoded defaults as fallbacks
        self.cached_minting_fee = Web3.to_wei(0.01, 'ether')  # Default 0.01 PHRS
    ...
    def get_gas_price(self):
        ...
        # Method 4: Use hardcoded fallback
        fallback_gas = Web3.to_wei(20, 'gwei')
