...
╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝
    """)
    print("Pharos Username Minter v7.6 | Final Version with Verified Transaction Parameters")
    print("=" * 60)
...
class PharosMultiMinter:
    ...
    def get_gas_price(self):
        ...
        if gas_prices:
            ...
            adjustment = random.uniform(1.1, 1.3)
            ...
            default_gas = Web3.to_wei(1, 'gwei')
    ...
    def estimate_commit_gas(self, commitment):
        ...
        if gas_estimate is not None:
            gas_limit = int(gas_estimate * 1.6)
    ...
    def mint_username(self, max_attempts=7):
        ...
        Commit hanya sekali per username, kemudian jika register gagal,
        retry register hingga 10 kali dengan secret & commitment yang sama.
        """
        for attempt in range(max_attempts):
            ...
            # Step 1: Make commitment (hanya sekali)
            ...
            # Tunggu commitment mature
            min_age = self.cached_min_commitment_age
            wait_time = max(min_age, 60) + 15
            ...
            # Verifikasi ulang sebelum register
            ...
            # Step 2: Register dengan retry hingga 10 kali
            print("  🔏 Registering username...")
            for reg_attempt in range(10):  # <= 10 percobaan register per username
            ...
            print("  ❌ All 10 registration attempts failed for this username, trying another")
            time.sleep(2)
