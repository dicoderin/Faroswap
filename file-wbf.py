...
# =============================================
# POA MIDDLEWARE COMPATIBILITY SOLUTION (FIXED)
# =============================================
...
# =============================================
# CONTRACT ABI (UPDATED FOR COMMIT-REGISTER PROCESS)
# =============================================
...
# =============================================
# PHAROS USERNAME MINTER CLASS (ENHANCED)
# =============================================
class PharosMultiMinter:
    ...
    def get_gas_price(self):
        ...
        # Try method 3: Use history if available
    ...
    def sign_and_send_transaction(self, tx):
        """Sign and send transaction with version compatibility"""
        try:
            # Sign transaction
    ...
    def make_commitment(self, full_username):
        ...
        try:
            ...
            try:
                ...
                print(f"  ⛽ Commit gas estimate: {gas_estimate} (using {tx['gas']})")
            except Exception as e:
    ...
    def register_username(self, full_username, secret):
        ...
        try:
            ...
            try:
                ...
                # Add 50% buffer for register
                tx['gas'] = int(gas_estimate * 1.5)
                print(f"  ⛽ Register gas estimate: {gas_estimate} (using {tx['gas']})")
            except Exception as e:
